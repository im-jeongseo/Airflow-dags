...
def preprocessing(ti):
    ...
    processed_items.to_csv ("/opt/airflow/dags/repo/naver_processed_result.csv", index=None, header=False)


def load_csv_to_postgres():
    # Read CSV file into a Pandas DataFrame
    df = pd.read_csv('/opt/airflow/dags/repo/naver_processed_result.csv')
